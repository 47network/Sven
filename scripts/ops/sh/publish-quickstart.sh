...
TMP_ARCHIVE="$(mktemp "${TMPDIR:-/tmp}/sven-quickstart-src.XXXXXX.tar.gz")"
...
$SUDO cp "$TMP_ARCHIVE" "$TARGET_DIR/source/sven-src.tar.gz"
...
echo "  curl -I https://sven.systems/source/sven-src.tar.gz"
