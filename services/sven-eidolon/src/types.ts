...
export type EidolonBuildingKind =
  ...
  | 'compliance_scanner'
  | 'backup_vault'
  | 'traffic_shaper' | 'service_mesh' | 'wan_optimizer' | 'link_aggregator' | 'protocol_gateway' | 'vlan_manager' | 'network_tap' | 'flow_collector' | 'sflow_agent' | 'netflow_exporter' | 'arp_inspector' | 'packet_sniffer' | 'bandwidth_monitor' | 'latency_probe' | 'jitter_analyzer' | 'packet_loss_tracker'
  | 'log_rotator'
  | 'ip_gatekeeper'
  | 'webhook_relay'
  | 'storage_tower'
