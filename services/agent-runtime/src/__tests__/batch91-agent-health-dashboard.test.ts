...
describe('Batch 91 — Agent Health Dashboard', () => {
  ...
  describe('Shared types', () => {
    ...
    it('exports HealthStatus', () => { expect(src).toContain("export type HealthStatus"); });
    it('exports WidgetType', () => { expect(src).toContain("export type WidgetType"); });
    it('exports AlertSeverity', () => { expect(src).toContain("export type AlertSeverity"); });
    it('exports HealthCheck interface', () => { expect(src).toContain("export interface HealthCheck"); });
    ...
    it('exports isHealthy helper', () => { expect(src).toContain("export function isHealthy"); });
