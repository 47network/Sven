...
| Local Testing Guide | [docs/release/LOCAL_TESTING_GUIDE.md](docs/release/LOCAL_TESTING_GUIDE.md) |
...
- General support: `support@the47network.com`
- Privacy and data rights: `privacy@the47network.com`
- Security disclosures: `security@the47network.com`
...
This is an open-source project maintained by a small team. We aim to respond to issues within **2–3 business days** but cannot guarantee resolution timelines for every request. Well-documented issues with reproduction steps get resolved fastest.
