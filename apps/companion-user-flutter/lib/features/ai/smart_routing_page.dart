    ...
    return _card(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          _statRow('Total requests',
              '${_stats['total_requests'] ?? 0}', isDark),
          _statRow('Routed locally',
              '${_stats['local_count'] ?? 0}', isDark),
          _statRow('Routed to cloud',
              '${_stats['cloud_count'] ?? 0}', isDark),
          _statRow('Avg latency (local)',
              '${_stats['avg_local_ms'] ?? 0}ms', isDark),
          _statRow('Avg latency (cloud)',
              '${_stats['avg_cloud_ms'] ?? 0}ms', isDark),
        ],
      ),
    );
  }
