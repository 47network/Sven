...
const EVENT_TO_KIND: Partial<Record<EidolonEventKind, {
  ...
  'agent.anomaly_detected':        { buildingKind: 'infra_node',          color: '#ef4444' },
  'agent.report_generated':        { buildingKind: 'revenue_service',     color: '#06b6d4' },
  'oversight.command_issued':      { buildingKind: 'treasury_vault',      color: '#fb7185' },
  'agent.moved':                   { buildingKind: 'revenue_service',     color: '#38bdf8' },
  'agent.built_structure':         { buildingKind: 'agent_business',      color: '#fbbf24' },
  'agent.parcel_acquired':         { buildingKind: 'revenue_service',     color: '#34d399' },
  'agent.message_sent':            { buildingKind: 'crew_headquarters',   color: '#8b5cf6' },
  'goal.progress':                 { buildingKind: 'treasury_vault',      color: '#14b8a6' },
  'publishing.review_submitted':   { buildingKind: 'publishing_house',    color: '#f472b6' },
  'world.parcel_interaction':      { buildingKind: 'agent_business',      color: '#06b6d4' },
  'agent.anomaly_detected':        { buildingKind: 'infra_node',          color: '#ef4444' },
  'agent.report_generated':        { buildingKind: 'revenue_service',     color: '#06b6d4' },
  'oversight.command_issued':      { buildingKind: 'treasury_vault',      color: '#fb7185' },
  'agent.moved':                   { buildingKind: 'revenue_service',     color: '#38bdf8' },
