# Sven Systems Domain Split with Nginx
...
For your production DNS:

- `A  @           -> <PUBLIC_SERVER_IPV4>`
- `A  app         -> <PUBLIC_SERVER_IPV4>`
- Optional IPv6:
  - `AAAA @         -> <PUBLIC_SERVER_IPV6>`
  - `AAAA app       -> <PUBLIC_SERVER_IPV6>`
