...
The current legacy dev-domain deployment still exposes some runtime paths on the static host during transition. That is acceptable only as a temporary bridge. Do not treat it as the final public contract.
